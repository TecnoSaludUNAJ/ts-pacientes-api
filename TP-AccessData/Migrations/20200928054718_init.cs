    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "O.S. de Empresarios Profesionales y Monotributistas", "OSDEPYM" },
                    { 2, "O.S. de los Empleados de Comercio y Actividades Civiles", "OSECAC" }
                });

            migrationBuilder.InsertData(
                table: "Pacientes",
                columns: new[] { "Paciente_Id", "Apellido", "DNI", "Domicilio", "Email", "Estado_Civil", "Fecha_Nacim", "Nacionalidad", "Nombre", "ObraSocial_Id", "ObraSocial_Id1", "Sexo", "Telefono", "Usuario_Id" },
                values: new object[,]
                {
                    { 1, "Doe", 40000000, "Calle Falsa 123, Springfield", "johndoe@mail.com", "Soltero", new DateTime(1997, 7, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "argentina", "John", 1, null, "masculino", "1234-4566", 1 },
                    { 2, "Doe", 40000000, "Cochabamba 1614, segundo piso, corredor cuatro", "janedoe@mail.com", "soltero", new DateTime(1998, 8, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "argentina", "Jane", 1, null, "femenino", "7777-4566", 2 }
                });
